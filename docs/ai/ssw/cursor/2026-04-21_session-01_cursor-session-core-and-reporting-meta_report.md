...
- **브랜치:** `main` → `origin/main`
- **주요 커밋(규칙·checkpoint·리포트 본문):** `5111573` — `docs: update session core and reporting meta rules`
- **후속(메타 해시 정합 등):** `1780b90` — `docs: align session report meta with HEAD`
- **최신(리포트 Meta 정리):** `327e563` — `docs: clarify session report meta (commits 5111573, 1780b90)`
